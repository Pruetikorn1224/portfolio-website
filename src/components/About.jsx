...
const About = () => {
  return (
    <section id='about' className='w-full h-screen font-sans p-32 relative max-xl:h-[32rem] max-md:p-16 max-sm:p-8'>
        ...
        <h3 className='absolute top-[28rem] text-4xl font-medium text-blue-500 pb-32 animate-start z-10 max-xl:text-3xl max-xl:top-72 max-xl:pb-6 max-sm:text-xl'>
          IT Risk Management Officer&ensp;
          <a className='text-3xl font-medium text-blue-500 pb-32 animate-start z-12 underline max-xl:inline max-xl:text-2xl max-sm:text-lg' href='https://www.bot.or.th/th/home.html'>@Bank of Thailand</a>
        </h3>
